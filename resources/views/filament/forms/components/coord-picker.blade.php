@php
    ...
    $initVal = ($initLat && $initLng) ? $initLat . ', ' . $initLng : '';
@endphp
<div x-data="{
    combined: '{{ $initVal }}',
    init() {
        if (this.combined) this.syncHidden();
    ...
    syncHidden() {
        ...
        var latEl = document.getElementById('fp-lat-input');
        var lngEl = document.getElementById('fp-lng-input');
    ...
    <label style="display:flex;align-items:center;gap:6px;font-size:13px;font-weight:500;color:#374151;margin-bottom:6px">
        ...
        Koordinatalar
        <span style="font-size:11px;color:#9ca3af;font-weight:400">(kenglik, uzunlik)</span>
    </label>
    <div style="display:flex;gap:8px;align-items:center">
        <input
            ...
            type="text"
            placeholder="Masalan: 40.857500, 68.929654"
